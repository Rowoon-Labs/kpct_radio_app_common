...
_$LevelImpl _$$LevelImplFromJson(Map<String, dynamic> json) => _$LevelImpl(
      ...
      category:
          const StringToGearCategoryConverter().fromJson(json['category']),
      ...
      getEp24HRate:
          const StringToIntConverter().fromJson(json['getEP_24hRate']),
      getSsp24HRate:
          const StringToIntConverter().fromJson(json['getSSP_24hRate']),
      getSspPlay: const StringToIntConverter().fromJson(json['getSSP_Play']),
      getEp24HAmount:
          const StringToIntConverter().fromJson(json['getEP_24hAmount']),
      getSsp24HAmount:
          const StringToIntConverter().fromJson(json['getSSP_24hAmount']),
      getSspPlayDelay:
          const StringToIntConverter().fromJson(json['getSSP_PlayDelay']),
      getSspPlayAmount:
          const StringToIntConverter().fromJson(json['getSSP_PlayAmount']),
    );
...
Map<String, dynamic> _$$LevelImplToJson(_$LevelImpl instance) =>
    <String, dynamic>{
      ...
      'category':
          const StringToGearCategoryConverter().toJson(instance.category),
      'name': instance.name,
      'icon': instance.icon,
      'tier': const StringToGearTierConverter().toJson(instance.tier),
      'socket_min': _$JsonConverterToJson<dynamic, int>(
          instance.socketMin, const StringToIntConverter().toJson),
      'socket_max': _$JsonConverterToJson<dynamic, int>(
          instance.socketMax, const StringToIntConverter().toJson),
      'staminaMax': _$JsonConverterToJson<dynamic, int>(
          instance.staminaMax, const StringToIntConverter().toJson),
      'staminaUse': _$JsonConverterToJson<dynamic, int>(
          instance.staminaUse, const StringToIntConverter().toJson),
      'luck_addrate': _$JsonConverterToJson<dynamic, int>(
          instance.luckAddrate, const StringToIntConverter().toJson),
      'listeningEP': _$JsonConverterToJson<dynamic, int>(
          instance.listeningEp, const StringToIntConverter().toJson),
      'listeningSSP': _$JsonConverterToJson<dynamic, int>(
          instance.listeningSsp, const StringToIntConverter().toJson),
      'getEXP': _$JsonConverterToJson<dynamic, int>(
          instance.getExp, const StringToIntConverter().toJson),
      'getEP_24hRate': _$JsonConverterToJson<dynamic, int>(
          instance.getEp24HRate, const StringToIntConverter().toJson),
      'getSSP_24hRate': _$JsonConverterToJson<dynamic, int>(
          instance.getSsp24HRate, const StringToIntConverter().toJson),
      'getSSP_Play': _$JsonConverterToJson<dynamic, int>(
          instance.getSspPlay, const StringToIntConverter().toJson),
      'getEP_24hAmount': _$JsonConverterToJson<dynamic, int>(
          instance.getEp24HAmount, const StringToIntConverter().toJson),
      'getSSP_24hAmount': _$JsonConverterToJson<dynamic, int>(
          instance.getSsp24HAmount, const StringToIntConverter().toJson),
      'getSSP_PlayDelay': _$JsonConverterToJson<dynamic, int>(
          instance.getSspPlayDelay, const StringToIntConverter().toJson),
      'getSSP_PlayAmount': _$JsonConverterToJson<dynamic, int>(
          instance.getSspPlayAmount, const StringToIntConverter().toJson),
    };
