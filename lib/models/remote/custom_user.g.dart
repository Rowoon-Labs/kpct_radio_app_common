...
_$CustomUserImpl _$$CustomUserImplFromJson(Map<String, dynamic> json) =>
    _$CustomUserImpl(
      ...
      accumulatedPlayDuration: const SecondConverter()
          .fromJson((json['accumulatedPlayDuration'] as num).toInt()),
      ...
      installedEquipments:
          (json['installedEquipments'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(
      ...
      nextRandomBoxAt: const TimestampConverter()
          .fromJson(json['nextRandomBoxAt'] as Timestamp),
      nextPeriodic12: _$JsonConverterFromJson<Timestamp, DateTime>(
          json['nextPeriodic12'], const TimestampConverter().fromJson),
      nextPeriodic24: _$JsonConverterFromJson<Timestamp, DateTime>(
          json['nextPeriodic24'], const TimestampConverter().fromJson),
      overcomeLevels: (json['overcomeLevels'] as List<dynamic>)
...
Map<String, dynamic> _$$CustomUserImplToJson(_$CustomUserImpl instance) =>
    <String, dynamic>{
      ...
      'accumulatedPlayDuration':
          const SecondConverter().toJson(instance.accumulatedPlayDuration),
      'radioSsp': instance.radioSsp,
      'accumulatedRadioSsp': instance.accumulatedRadioSsp,
      'hodSsp': instance.hodSsp,
      'referralCode': instance.referralCode,
      'installedEquipments': instance.installedEquipments
          .map((k, e) => MapEntry(_$GearCategoryEnumMap[k]!, e)),
      'nextRandomBoxAt':
          const TimestampConverter().toJson(instance.nextRandomBoxAt),
      'nextPeriodic12': _$JsonConverterToJson<Timestamp, DateTime>(
          instance.nextPeriodic12, const TimestampConverter().toJson),
      'nextPeriodic24': _$JsonConverterToJson<Timestamp, DateTime>(
          instance.nextPeriodic24, const TimestampConverter().toJson),
...
_$ItemImpl _$$ItemImplFromJson(Map<String, dynamic> json) => _$ItemImpl(
      ...
      lastBuyAt:
          const TimestampConverter().fromJson(json['lastBuyAt'] as Timestamp),
      effectEndAt: _$JsonConverterFromJson<Timestamp, DateTime>(
              json['effectEndAt'], const TimestampConverter().fromJson) ??
          null,
    );
...
Map<String, dynamic> _$$ItemImplToJson(_$ItemImpl instance) =>
    <String, dynamic>{
      ...
      'effectEndAt': _$JsonConverterToJson<Timestamp, DateTime>(
          instance.effectEndAt, const TimestampConverter().toJson),
    };
