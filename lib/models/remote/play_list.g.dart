...
_$PlayListImpl _$$PlayListImplFromJson(Map<String, dynamic> json) =>
    _$PlayListImpl(
      ...
      videos: (json['videos'] as List<dynamic>)
          ...
          .toList(),
      totalDuration: const SecondConverter()
...
_$VideoImpl _$$VideoImplFromJson(Map<String, dynamic> json) => _$VideoImpl(
      ...
      limitPlayDuration: const SecondConverter()
          .fromJson((json['limitPlayDuration'] as num).toInt()),
      duration:
          const SecondConverter().fromJson((json['duration'] as num).toInt()),
    );
...
Map<String, dynamic> _$$VideoImplToJson(_$VideoImpl instance) =>
    <String, dynamic>{
      ...
      'limitPlayDuration':
          const SecondConverter().toJson(instance.limitPlayDuration),
