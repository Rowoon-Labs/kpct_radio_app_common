    ...
    return _then(_value.copyWith(
      ...
      transactedAt: freezed == transactedAt
          ...
          : transactedAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      totalSsp: freezed == totalSsp
          ? _value.totalSsp
          : totalSsp // ignore: cast_nullable_to_non_nullable
              as int?,
      totalEp: freezed == totalEp
          ? _value.totalEp
...
class _$TransactionLogImpl extends _TransactionLog {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, content, deltaSsp, deltaEp,
      createdAt, email, userId, transactedAt, totalSsp, totalEp);
...
abstract class _TransactionLog extends TransactionLog {
  const factory _TransactionLog(
      ...
      required final int? totalEp}) = _$TransactionLogImpl;
